...
class AdEscrowBot:
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        try:
            ...
            await update.message.reply_text("⚠️ Could not show help menu. Please contact admin.")
    ...
    async def help_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if webapp_url:
            ...
            logger.warning("WEBAPP_URL not set, hiding Open Marketplace button in help")
